...
describe("userService", () => {
    describe("findUserByCredentials", () => {
        it("should throw an authentication-error when the user does'nt exist",
            () => {
                expect(async () => {
        ...
        it("should throw an authentication-error when the password is wrong",
            () => {
                expect(async () => {
        ...
        it("given the credentials of an existing user it should return the User",
            async () => {
                const spy = jest.fn();
    ...
    describe("findByID", () => {
        ...
        it("should return the null if the user does not exist???",
            async () => {
        ...
        it("should return the user if the user exists an existing user",
            async () => {
                const user = new User({username: "username", password: "password"});
